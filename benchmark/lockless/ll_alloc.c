...
void *PREFIX(aligned_alloc)(size_t alignment, size_t size);
...
static noinline void *aligned_alloc_aux(size_t align, size_t size)
{
	...
	return PREFIX(aligned_alloc)(align, size);
}
...
void *PREFIX(aligned_alloc)(size_t align, size_t size)
{
	DECL_PROF_FUNC;
...
int posix_memalign(void **p, size_t align, size_t size)
{
	...
	*p = PREFIX(aligned_alloc)(align, size);
...
void *valloc(size_t size)
{
	return PREFIX(aligned_alloc)(PAGESIZE, size);
}

void *pvalloc(size_t size)
{
	return PREFIX(aligned_alloc)(PAGESIZE, page_align(size));
}
